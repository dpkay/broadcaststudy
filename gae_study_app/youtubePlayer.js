(function(global) {
    ...
    YoutubePlayer.prototype.embed = function() {
        ...
        var videoUrl = 'http://www.youtube.com/apiplayer?enablejsapi=1&playerapiid={playerId}&version=3';
        videoUrl = videoUrl.replace('{playerId}', this.videoId);
    ...
    YoutubePlayer.prototype.fireEvent = function(eventName) {
        ...
        for(var i = 0; i < handlers.length; i++) {
            handlers[i](eventName, this.videoId);
        }
    };
    ...
    global.onYouTubePlayerReady = function(playerId) {
        //var clip = YoutubePlayer.findById(playerId);
        var player = YoutubePlayer.findById(playerId + "_container");
        //alert(player);
        player.onReady();
//        var clip = document.getElementById(playerId + "_container");
        //alert(clip);
  //      clip.loadVideoById(playerId);
    //    clip.onReady();
    };
